CREATE TABLE Questions (
    ...
    FOREIGN KEY (textbook_id, chapter_id, section_id, block_id, unique_activity_id) REFERENCES Activity(textbook_id, chapter_id, section_id, block_id, unique_activity_id) ON DELETE CASCADE
);




INSERT INTO `Questions` (textbook_id, chapter_id, section_id, block_id, unique_activity_id, question_id, question_text, option_1, opt_1_explanation, option_2, opt_2_explanation, option_3, opt_3_explanation, option_4, opt_4_explanation, answer) 
VALUES
